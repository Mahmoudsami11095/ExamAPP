export class AuthEndPoint {
  ...
  static readonly CHANGEPASSWORD = 'https://exam.elevateegy.com/api/v1/auth/changePassword';
  ...
  static readonly FORGOTPASSWORD = 'https://exam.elevateegy.com/api/v1/auth/forgotPassword';
